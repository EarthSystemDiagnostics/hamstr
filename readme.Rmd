---
title: "hamstr: Hierarchical Accumulation Modelling (with Stan in R)."
output: 
  html_document: 
    keep_md: yes
editor_options: 
...
# baconr does not match output of Bacon2.2 when mem_mean = 0.1, mem_strength = 4
# in baconr the prior is strong and dominates, in Bacon2.2 the data dominate the prior
