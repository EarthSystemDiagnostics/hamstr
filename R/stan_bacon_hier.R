...
#'
#' @examples
stan_bacon_hier <- function(depth, obs_age, obs_err,
                            #hiatus_depth = NULL, hiatus_length = NULL,
                            #hiatus_shape = 1, hiatus_interval = 0.1,
                            K = 10, nu = 6,
                            acc_mean_mean, acc_mean_shape = 1.5, acc_alpha = 1.5,
  ...
  stan_dat <- make_stan_dat(depth=depth, obs_age=obs_age, obs_err=obs_err,
                            ...
                            K=K, nu=nu,
                            acc_mean_mean = acc_mean_mean, acc_mean_shape = acc_mean_shape,
                            acc_alpha = acc_alpha, 
                            mem_mean=mem_mean, mem_strength=mem_strength)
  
  fit <- rstan::sampling(stanmodels$bacon_hier_acc_mean,
